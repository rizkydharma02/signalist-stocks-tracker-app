  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="text-gray-400">
        ...
        <DropdownMenuItem onClick={handleSignOut} className="focus:bg-transparent font-medium text-gray-100 text-md focus:text-yellow-500 transition-colors cursor-pointer">
